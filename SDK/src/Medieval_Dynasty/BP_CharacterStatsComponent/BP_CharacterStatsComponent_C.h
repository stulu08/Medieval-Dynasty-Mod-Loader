#pragma once
#include "Structs.h"
#include "Medieval_Dynasty/StatsComponentBase.h"
/////////////////////////////////////////////
// BlueprintGeneratedClass BP_CharacterStatsComponent.BP_CharacterStatsComponent_C
// Super: Class Medieval_Dynasty.StatsComponentBase
// Size: 2144
// Size inherited: 944
/////////////////////////////////////////////
namespace UE4 {
class UBP_CharacterStatsComponent_C : public UStatsComponentBase {
public:
#pragma region Members
	//struct FPointerToUberGraphFrame	UberGraphFrame;		//Offset: 944	Size: 8	Flags: ZeroConstructor, Transient, DuplicateTransient
	...
	//struct FText	Name;		//Offset: 952	Size: 24	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	struct FText M_GetName() const;
	struct FText* M_PtrGetName();
	void M_SetName(const struct FText& value);

	//TEnumAsByte<E_Sex>	sex;		//Offset: 976	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	TEnumAsByte<E_Sex> M_Getsex() const;
	TEnumAsByte<E_Sex>* M_PtrGetsex();
	void M_Setsex(const TEnumAsByte<E_Sex>& value);

	//float	Age;		//Offset: 980	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	float M_GetAge() const;
	float* M_PtrGetAge();
	void M_SetAge(const float& value);

	//float	MinDeadAge;		//Offset: 984	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMinDeadAge() const;
	float* M_PtrGetMinDeadAge();
	void M_SetMinDeadAge(const float& value);

	//TEnumAsByte<E_CharacterType>	CharacterType;		//Offset: 988	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	...
	//int32_t	DeadChance;		//Offset: 992	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetDeadChance() const;
	int32_t* M_PtrGetDeadChance();
	void M_SetDeadChance(const int32_t& value);

	//bool	Dead;		//Offset: 996	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetDead() const;
	bool* M_PtrGetDead();
	void M_SetDead(const bool& value);

	//TAssetPtr<class FOnSkillChange__DelegateSignature>	OnSkillChange;		//Offset: 1000	Size: 16	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	//float	CurrentMood;		//Offset: 1016	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetCurrentMood() const;
	float* M_PtrGetCurrentMood();
	void M_SetCurrentMood(const float& value);

	//TArray<struct FST_MasterTalent>	Talents_Extraction;		//Offset: 1024	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//TArray<struct FST_MasterTalent>	Talents_Hunting;		//Offset: 1040	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//TArray<struct FST_MasterTalent>	Talents_Farming;		//Offset: 1056	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//TArray<struct FST_MasterTalent>	Talents_Diplomacy;		//Offset: 1072	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//TArray<struct FST_MasterTalent>	Talents_Survival;		//Offset: 1088	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//TArray<struct FST_MasterTalent>	Talents_Crafting;		//Offset: 1104	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//int32_t	MinerStacks;		//Offset: 1316	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetMinerStacks() const;
	int32_t* M_PtrGetMinerStacks();
	void M_SetMinerStacks(const int32_t& value);

	//int32_t	WoodcutterStacks;		//Offset: 1320	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetWoodcutterStacks() const;
	int32_t* M_PtrGetWoodcutterStacks();
	void M_SetWoodcutterStacks(const int32_t& value);

	//float	MinerStacksTimeOut;		//Offset: 1324	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMinerStacksTimeOut() const;
	float* M_PtrGetMinerStacksTimeOut();
	void M_SetMinerStacksTimeOut(const float& value);

	//float	Dirtiness;		//Offset: 1328	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	float M_GetDirtiness() const;
	float* M_PtrGetDirtiness();
	void M_SetDirtiness(const float& value);

	//float	Food;		//Offset: 1332	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	MaxHealth;		//Offset: 1340	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	float M_GetMaxHealth() const;
	float* M_PtrGetMaxHealth();
	void M_SetMaxHealth(const float& value);

	//float	health;		//Offset: 1344	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	...
	//float	water;		//Offset: 1352	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	CurrentSensedTemperature;		//Offset: 1488	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	...
	//float	ColdProtection;		//Offset: 1508	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetColdProtection() const;
	float* M_PtrGetColdProtection();
	void M_SetColdProtection(const float& value);

	//float	HeatProtection;		//Offset: 1512	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	Poison;		//Offset: 1536	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	...
	//bool	Overheating;		//Offset: 1544	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetOverheating() const;
	bool* M_PtrGetOverheating();
	void M_SetOverheating(const bool& value);

	//bool	Cold;		//Offset: 1545	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	...
	//bool	Poisoned;		//Offset: 1548	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	...
	//bool	NoFood;		//Offset: 1664	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetNoFood() const;
	bool* M_PtrGetNoFood();
	void M_SetNoFood(const bool& value);

	//bool	NoWater;		//Offset: 1665	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetNoWater() const;
	bool* M_PtrGetNoWater();
	void M_SetNoWater(const bool& value);

	//bool	NoWood;		//Offset: 1666	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetNoWood() const;
	bool* M_PtrGetNoWood();
	void M_SetNoWood(const bool& value);

	//bool	IsPlayingStatSFX;		//Offset: 1667	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetIsPlayingStatSFX() const;
	bool* M_PtrGetIsPlayingStatSFX();
	void M_SetIsPlayingStatSFX(const bool& value);

	//bool	StaminaSFX;		//Offset: 1668	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetStaminaSFX() const;
	bool* M_PtrGetStaminaSFX();
	void M_SetStaminaSFX(const bool& value);

	//struct FST_Event_CharacterMultipliers	EventMultipliers;		//Offset: 1672	Size: 28	Flags: Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//int32_t	MoodChangeSpeed;		//Offset: 1700	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetMoodChangeSpeed() const;
	int32_t* M_PtrGetMoodChangeSpeed();
	void M_SetMoodChangeSpeed(const int32_t& value);

	//TEnumAsByte<E_Directions>	MoodDirection;		//Offset: 1704	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//TAssetPtr<class FOnFoodChange__DelegateSignature>	OnFoodChange;		//Offset: 1712	Size: 16	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	//TAssetPtr<class FOnWaterChange__DelegateSignature>	OnWaterChange;		//Offset: 1728	Size: 16	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	//float	WoodcutterStacksTimeOut;		//Offset: 1744	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//int32_t	FarmerStacks;		//Offset: 1748	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetFarmerStacks() const;
	int32_t* M_PtrGetFarmerStacks();
	void M_SetFarmerStacks(const int32_t& value);

	//float	FarmerStacksTimeOut;		//Offset: 1752	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetFarmerStacksTimeOut() const;
	float* M_PtrGetFarmerStacksTimeOut();
	void M_SetFarmerStacksTimeOut(const float& value);

	//int32_t	BuilderStacks;		//Offset: 1756	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetBuilderStacks() const;
	int32_t* M_PtrGetBuilderStacks();
	void M_SetBuilderStacks(const int32_t& value);

	//float	BuilderStacksTimeOut;		//Offset: 1760	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetBuilderStacksTimeOut() const;
	float* M_PtrGetBuilderStacksTimeOut();
	void M_SetBuilderStacksTimeOut(const float& value);

	//bool	IsWaterBlinking;		//Offset: 1764	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetIsWaterBlinking() const;
	bool* M_PtrGetIsWaterBlinking();
	void M_SetIsWaterBlinking(const bool& value);

	//bool	IsFoodBlinking;		//Offset: 1765	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetIsFoodBlinking() const;
	bool* M_PtrGetIsFoodBlinking();
	void M_SetIsFoodBlinking(const bool& value);

	//float	TimeSinceLastWaterBlink;		//Offset: 1768	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	WaterBlinkingActualTime;		//Offset: 1772	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	BlinkingUpdateFrequency;		//Offset: 1776	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//struct FTimerHandle	WaterBlinkTimer;		//Offset: 1784	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//float	TimeSinceLastFoodBlink;		//Offset: 1792	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	FoodBlinkingActualTime;		//Offset: 1796	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//struct FTimerHandle	FoodBlinkTimer;		//Offset: 1800	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//float	FoodBlinkingProcessTime;		//Offset: 1808	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	WaterBlinkingProcessTime;		//Offset: 1812	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	Alcohol;		//Offset: 1816	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash
	float M_GetAlcohol() const;
	float* M_PtrGetAlcohol();
	void M_SetAlcohol(const float& value);

	//float	AlcoholDecreaseRate;		//Offset: 1820	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetAlcoholDecreaseRate() const;
	float* M_PtrGetAlcoholDecreaseRate();
	void M_SetAlcoholDecreaseRate(const float& value);

	//bool	Drunk;		//Offset: 1824	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetDrunk() const;
	bool* M_PtrGetDrunk();
	void M_SetDrunk(const bool& value);

	//TAssetPtr<class FOnAlcoholChange__DelegateSignature>	OnAlcoholChange;		//Offset: 1832	Size: 16	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	//bool	IsPoisonBlinking;		//Offset: 1848	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetIsPoisonBlinking() const;
	bool* M_PtrGetIsPoisonBlinking();
	void M_SetIsPoisonBlinking(const bool& value);

	//float	TimeSinceLastPoisonBlink;		//Offset: 1852	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	PoisonBlinkingActualTime;		//Offset: 1856	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//struct FTimerHandle	PoisonBlinkTimer;		//Offset: 1864	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//float	PoisonBlinkingProcessTime;		//Offset: 1872	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	SafeLowTemperature;		//Offset: 1876	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSafeLowTemperature() const;
	float* M_PtrGetSafeLowTemperature();
	void M_SetSafeLowTemperature(const float& value);

	//float	SafeHighTemperature;		//Offset: 1880	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSafeHighTemperature() const;
	float* M_PtrGetSafeHighTemperature();
	void M_SetSafeHighTemperature(const float& value);

	//float	TemperatureToleranceModifier;		//Offset: 1884	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//TEnumAsByte<E_NPCPersonality>	Personality;		//Offset: 1888	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//class ABP_ChromaManager_C*	RazerChromaSystem;		//Offset: 1896	Size: 8	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//bool	MoreDamage;		//Offset: 1904	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetMoreDamage() const;
	bool* M_PtrGetMoreDamage();
	void M_SetMoreDamage(const bool& value);

	//float	MoreDamageTime;		//Offset: 1908	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreDamageTime() const;
	float* M_PtrGetMoreDamageTime();
	void M_SetMoreDamageTime(const float& value);

	//bool	NightVision;		//Offset: 1912	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetNightVision() const;
	bool* M_PtrGetNightVision();
	void M_SetNightVision(const bool& value);

	//float	NightVisionTime;		//Offset: 1916	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetNightVisionTime() const;
	float* M_PtrGetNightVisionTime();
	void M_SetNightVisionTime(const float& value);

	//bool	MoreWeight;		//Offset: 1920	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetMoreWeight() const;
	bool* M_PtrGetMoreWeight();
	void M_SetMoreWeight(const bool& value);

	//float	MoreWeightTime;		//Offset: 1924	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreWeightTime() const;
	float* M_PtrGetMoreWeightTime();
	void M_SetMoreWeightTime(const float& value);

	//bool	AnimalRepel;		//Offset: 1928	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetAnimalRepel() const;
	bool* M_PtrGetAnimalRepel();
	void M_SetAnimalRepel(const bool& value);

	//float	AnimalRepelTime;		//Offset: 1932	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetAnimalRepelTime() const;
	float* M_PtrGetAnimalRepelTime();
	void M_SetAnimalRepelTime(const float& value);

	//bool	BetterTemperatureTolerance;		//Offset: 1936	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	...
	//float	BetterTemperatureToleranceTime;		//Offset: 1940	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//bool	SlowerWaterDrop;		//Offset: 1944	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetSlowerWaterDrop() const;
	bool* M_PtrGetSlowerWaterDrop();
	void M_SetSlowerWaterDrop(const bool& value);

	//float	SlowerWaterDropTime;		//Offset: 1948	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSlowerWaterDropTime() const;
	float* M_PtrGetSlowerWaterDropTime();
	void M_SetSlowerWaterDropTime(const float& value);

	//bool	SlowerHungerDrop;		//Offset: 1952	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetSlowerHungerDrop() const;
	bool* M_PtrGetSlowerHungerDrop();
	void M_SetSlowerHungerDrop(const bool& value);

	//float	SlowerHungerDropTime;		//Offset: 1956	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSlowerHungerDropTime() const;
	float* M_PtrGetSlowerHungerDropTime();
	void M_SetSlowerHungerDropTime(const float& value);

	//bool	SlowerStaminaDrop;		//Offset: 1960	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetSlowerStaminaDrop() const;
	bool* M_PtrGetSlowerStaminaDrop();
	void M_SetSlowerStaminaDrop(const bool& value);

	//float	SlowerStaminaDropTime;		//Offset: 1964	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//bool	TimeHeal;		//Offset: 1968	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetTimeHeal() const;
	bool* M_PtrGetTimeHeal();
	void M_SetTimeHeal(const bool& value);

	//float	TimeHealTime;		//Offset: 1972	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTimeHealTime() const;
	float* M_PtrGetTimeHealTime();
	void M_SetTimeHealTime(const float& value);

	//float	TimeHealIntensityPerSecond;		//Offset: 1976	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//bool	MoreHP;		//Offset: 1980	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetMoreHP() const;
	bool* M_PtrGetMoreHP();
	void M_SetMoreHP(const bool& value);

	//float	TimePerTimeUpdate;		//Offset: 1984	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTimePerTimeUpdate() const;
	float* M_PtrGetTimePerTimeUpdate();
	void M_SetTimePerTimeUpdate(const float& value);

	//float	MoreHPTime;		//Offset: 1988	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreHPTime() const;
	float* M_PtrGetMoreHPTime();
	void M_SetMoreHPTime(const float& value);

	//float	MoreWeightAmount;		//Offset: 1992	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreWeightAmount() const;
	float* M_PtrGetMoreWeightAmount();
	void M_SetMoreWeightAmount(const float& value);

	//float	MoreDamageMultiplier;		//Offset: 1996	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreDamageMultiplier() const;
	float* M_PtrGetMoreDamageMultiplier();
	void M_SetMoreDamageMultiplier(const float& value);

	//float	SlowerWaterDropMultiplier;		//Offset: 2000	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	SlowerHungerDropMulitplier;		//Offset: 2004	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	SlowerStaminaDropMultiplier;		//Offset: 2008	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	MoreHPAmount;		//Offset: 2012	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreHPAmount() const;
	float* M_PtrGetMoreHPAmount();
	void M_SetMoreHPAmount(const float& value);

	//float	BetterTemperatureToleranceAmount;		//Offset: 2016	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//bool	TimeUnpoison;		//Offset: 2020	Size: 1	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor
	bool M_GetTimeUnpoison() const;
	bool* M_PtrGetTimeUnpoison();
	void M_SetTimeUnpoison(const bool& value);

	//float	TimeUnpoisonTime;		//Offset: 2024	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTimeUnpoisonTime() const;
	float* M_PtrGetTimeUnpoisonTime();
	void M_SetTimeUnpoisonTime(const float& value);

	//float	TimeUnpoisonIntensityPerSecond;		//Offset: 2028	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	TimeSinceLastTimeHeal;		//Offset: 2032	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//struct FTimerHandle	PoisonTimer;		//Offset: 2040	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//float	AlcoholTolerance;		//Offset: 2048	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetAlcoholTolerance() const;
	float* M_PtrGetAlcoholTolerance();
	void M_SetAlcoholTolerance(const float& value);

	//struct FTimerHandle	PlayerReactionTimer;		//Offset: 2056	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	struct FTimerHandle M_GetPlayerReactionTimer() const;
	struct FTimerHandle* M_PtrGetPlayerReactionTimer();
	void M_SetPlayerReactionTimer(const struct FTimerHandle& value);

	//float	MoreDamageMaxTime;		//Offset: 2064	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreDamageMaxTime() const;
	float* M_PtrGetMoreDamageMaxTime();
	void M_SetMoreDamageMaxTime(const float& value);

	//float	NightVisionMaxTime;		//Offset: 2068	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetNightVisionMaxTime() const;
	float* M_PtrGetNightVisionMaxTime();
	void M_SetNightVisionMaxTime(const float& value);

	//float	MoreWeightMaxTime;		//Offset: 2072	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreWeightMaxTime() const;
	float* M_PtrGetMoreWeightMaxTime();
	void M_SetMoreWeightMaxTime(const float& value);

	//float	AnimalRepelMaxTime;		//Offset: 2076	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetAnimalRepelMaxTime() const;
	float* M_PtrGetAnimalRepelMaxTime();
	void M_SetAnimalRepelMaxTime(const float& value);

	//float	BetterTemperatureToleranceMaxTime;		//Offset: 2080	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetBetterTemperatureToleranceMaxTime() const;
	float* M_PtrGetBetterTemperatureToleranceMaxTime();
	void M_SetBetterTemperatureToleranceMaxTime(const float& value);

	//float	SlowerWaterDropMaxTime;		//Offset: 2084	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSlowerWaterDropMaxTime() const;
	float* M_PtrGetSlowerWaterDropMaxTime();
	void M_SetSlowerWaterDropMaxTime(const float& value);

	//float	SlowerHungerDropMaxTime;		//Offset: 2088	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSlowerHungerDropMaxTime() const;
	float* M_PtrGetSlowerHungerDropMaxTime();
	void M_SetSlowerHungerDropMaxTime(const float& value);

	//float	SlowerStaminaDropMaxTime;		//Offset: 2092	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetSlowerStaminaDropMaxTime() const;
	float* M_PtrGetSlowerStaminaDropMaxTime();
	void M_SetSlowerStaminaDropMaxTime(const float& value);

	//float	TimeHealMaxTime;		//Offset: 2096	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTimeHealMaxTime() const;
	float* M_PtrGetTimeHealMaxTime();
	void M_SetTimeHealMaxTime(const float& value);

	//float	MoreHPMaxTime;		//Offset: 2100	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetMoreHPMaxTime() const;
	float* M_PtrGetMoreHPMaxTime();
	void M_SetMoreHPMaxTime(const float& value);

	//float	TimeUnpoisonMaxTime;		//Offset: 2104	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTimeUnpoisonMaxTime() const;
	float* M_PtrGetTimeUnpoisonMaxTime();
	void M_SetTimeUnpoisonMaxTime(const float& value);

	//struct FTimerHandle	NPCStaminaTimer;		//Offset: 2112	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	struct FTimerHandle M_GetNPCStaminaTimer() const;
	struct FTimerHandle* M_PtrGetNPCStaminaTimer();
	void M_SetNPCStaminaTimer(const struct FTimerHandle& value);

	//float	NPCWorkingSpeed;		//Offset: 2120	Size: 4	Flags: Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetNPCWorkingSpeed() const;
	float* M_PtrGetNPCWorkingSpeed();
	void M_SetNPCWorkingSpeed(const float& value);

	//TAssetPtr<class FOnSkillClientUpdated__DelegateSignature>	OnSkillClientUpdated;		//Offset: 2128	Size: 16	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	TAssetPtr<class FOnSkillClientUpdated__DelegateSignature> M_GetOnSkillClientUpdated() const;
	TAssetPtr<class FOnSkillClientUpdated__DelegateSignature>* M_PtrGetOnSkillClientUpdated();
	void M_SetOnSkillClientUpdated(const TAssetPtr<class FOnSkillClientUpdated__DelegateSignature>& value);
...
#pragma region Functions
	...
	void OnSkillClientUpdated__DelegateSignature();

	void ExecuteUbergraph_BP_CharacterStatsComponent(int32_t EntryPoint);

	void OnDaySkipStart(int32_t TimeRealSeconds, int32_t TimeUpdateSeconds);

	void OnAudioFinished_Multicast();

	void Client_UpdateTrance(float Time, int32_t NumberOfStacks, TEnumAsByte<E_TalentTrance> WoodcutterTrance_);

	void Client_RemoveTrance(TEnumAsByte<E_TalentTrance> WoodcutterTrance_);

	void Client_StartTrance(float TranceMaxTime, TEnumAsByte<E_TalentTrance> WoodcutterTrance_);
	...
	void StartPlayerReactionTimer(float Time);

	void CheckIfLowStamina();

	void UpdateStats_Client();

	void StopStatsTimer_BPI();

	void StartStatsTimer_BPI();
	...
	void Server_StopStackCounting(TEnumAsByte<E_TalentTrance> Woodcutter);

	void UpdateMinerStacks();

	void Server_StartStackCounting(TEnumAsByte<E_TalentTrance> WoodcutterTrance_, float TranceTime);

	void Multicast_UpdateTalentsCurrentLevel(ESkills SkillType, int32_t TalentIndex, int32_t TalentCurrentLevel);

	void PotionEffectStart(TEnumAsByte<E_Effects> Effect);

	void Client_PotionEffectChanged(TEnumAsByte<E_Effects> Effect, bool HasEffectEnded);

	void DecreaseHealth_Server(float health);

	void Server_UpdateClientHPOnStart();

	void Multicast_ReplicateAllTalents(const TArray<int32_t>& ExtractionTalents, const TArray<int32_t>& HuntingTalents, const TArray<int32_t>& FarmingTalents, const TArray<int32_t>& DiplomacyTalents, const TArray<int32_t>& SurvivalTalents, const TArray<int32_t>& CraftingTalents);

	void Server_ReplicateAllTalents();

	void DecreaseStaminaOnDamage_Client(float Stamina);

	void UpdateDirtiness_Server(float Dirtiness, bool IsSet);

	void UpdateStamina_Server(float Stamina);

	void OnHealthChanged_Client(bool Hit, TEnumAsByte<E_DamageType> Damage_Type, float health);

	void OnFoodChanged_Client();

	void OnWaterChanged_Client();

	void Consume_Server(float Food, float water, float health, float Stamina, float Poison, float Alcohol, float EffectDurationTime, float HealthPerSecond, float AdditionalMaxHP, float StaminaMultiplier, float FoodMultiplier, float WaterMultiplier, bool TurnOffHarmfulPoison, float PoisonPerSecond, bool NightVision, int32_t TemperatureTolerance, bool SkillsReset, float DamageMultiplier, bool AnimalRepel, float AdditionalWeight);

	void IncreaseCraftingServer(float Value, bool AffectedByCraftingTalent, bool AffectedBySewingTalent, bool AffectedByCookingTalent, bool AffectedByGameSettings);

	void AddSkillsServer(TEnumAsByte<E_Skills> Skill, float Value, bool AffectedByGameSettings);
	...
	void OnRep_Talents_Crafting();

	void SetFood(float NewValue);

	void SetHealth(float NewValue, bool Hit, TEnumAsByte<E_DamageType> Damage_Type);

	void SetMaxHealth(float newMaxHealth);

	void SetWater(float NewValue);

	void SetPoison(float NewValue);

	void HandlePlayerReactions();

	void DecreaseStaminaLocal(float Stamina, bool Ditrtness, bool* Enough);

	void SetName(struct FText Name);

	void ShouldUseCoopStatsProtection(bool* Value);

	void OnRep_Age();

	void SetAlcohol(float NewValue);
	...
	void OnRep_TimeUnpoison();

	void OnRep_SlowerStaminaDrop();

	void OnRep_SlowerHungerDrop();

	void OnRep_SlowerWaterDrop();

	void OnRep_AnimalRepel();

	void OnRep_BetterTemperatureTolerance();

	void OnRep_MoreWeight();

	void OnRep_MoreDamage();

	void OnRep_NightVision();

	void OnRep_MaxHealth();

	void GetDiplomacyTalentValueWithStacking(int32_t TalentIndex, int32_t StartingValue, int32_t* Value, float* MultiplierValue);

	void SetColdProtection(float ColdProtection);

	void SetHeatProtection(float HeatProtection);
	...
	void OnRep_CurrentSensedTemperature();
	...
	void ClampDirtiness(float Value, float* ClampedDirtiness);

	void SetPOI_NPCsSkills(struct FString NPC_ID);

	void SetPOI_Personality(struct FString NPC_ID);

	void OnRep_CharacterType();

	void UpdateNPCStamina();

	void UpdatePlayerEventMultipliers();

	void ResetComponent(bool ResetSkillsAndTalents);

	void ResetTalents(bool KeepSkillPoints);

	void SetEventMultipliers(struct FST_Event_CharacterMultipliers EventMultipliers);
	...
	float GetStamina_BPI();

	float GetMaxHealth_BPI();

	float GetHealth_BPI();

	void GetSex(TEnumAsByte<E_Sex>* sex);

	void GetItemSellPriceIncrease(float* PriceIncrease);

	void GetItemBuyPriceDecrease(float* PriceDecrease);

	void GetAnimalSellPriceIncrease(float* PriceIncrease);

	void GetAnimalBuyPriceDecrease(float* PriceDecrease);
