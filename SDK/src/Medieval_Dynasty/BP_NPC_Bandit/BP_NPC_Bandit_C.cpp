...
struct FPointerToUberGraphFrame ABP_NPC_Bandit_C::M_GetUberGraphFrame() const {
	return Read<struct FPointerToUberGraphFrame>((byte*)this + 7576);
}
struct FPointerToUberGraphFrame* ABP_NPC_Bandit_C::M_PtrGetUberGraphFrame() {
	return reinterpret_cast<struct FPointerToUberGraphFrame*>((byte*)this + 7576);
}
...
class AActor* ABP_NPC_Bandit_C::M_GetDamageCauser() const {
	return Read<class AActor*>((byte*)this + 7584);
}
class AActor** ABP_NPC_Bandit_C::M_PtrGetDamageCauser() {
	return reinterpret_cast<class AActor**>((byte*)this + 7584);
}
...
struct FTimerHandle ABP_NPC_Bandit_C::M_GetHitTimer() const {
	return Read<struct FTimerHandle>((byte*)this + 7592);
}
struct FTimerHandle* ABP_NPC_Bandit_C::M_PtrGetHitTimer() {
	return reinterpret_cast<struct FTimerHandle*>((byte*)this + 7592);
}
...
struct FVector ABP_NPC_Bandit_C::M_GetHitLocation() const {
	return Read<struct FVector>((byte*)this + 7600);
}
struct FVector* ABP_NPC_Bandit_C::M_PtrGetHitLocation() {
	return reinterpret_cast<struct FVector*>((byte*)this + 7600);
}
...
struct FName ABP_NPC_Bandit_C::M_GetHitBoneName() const {
	return Read<struct FName>((byte*)this + 7612);
}
struct FName* ABP_NPC_Bandit_C::M_PtrGetHitBoneName() {
	return reinterpret_cast<struct FName*>((byte*)this + 7612);
}
void ABP_NPC_Bandit_C::M_SetHitBoneName(const struct FName& value) {
	Write((byte*)this + 7612, value);
}
...
struct FVector ABP_NPC_Bandit_C::M_GetShotDirection() const {
	return Read<struct FVector>((byte*)this + 7620);
}
struct FVector* ABP_NPC_Bandit_C::M_PtrGetShotDirection() {
	return reinterpret_cast<struct FVector*>((byte*)this + 7620);
}
void ABP_NPC_Bandit_C::M_SetShotDirection(const struct FVector& value) {
	Write((byte*)this + 7620, value);
}
...
TEnumAsByte<E_AnimMovement> ABP_NPC_Bandit_C::M_GetAvoidMovement() const {
	return Read<TEnumAsByte<E_AnimMovement>>((byte*)this + 7675);
}
TEnumAsByte<E_AnimMovement>* ABP_NPC_Bandit_C::M_PtrGetAvoidMovement() {
	return reinterpret_cast<TEnumAsByte<E_AnimMovement>*>((byte*)this + 7675);
}
void ABP_NPC_Bandit_C::M_SetAvoidMovement(const TEnumAsByte<E_AnimMovement>& value) {
	Write((byte*)this + 7675, value);
}
...
bool ABP_NPC_Bandit_C::M_GetStopSimulatingRagdoll() const {
	return Read<bool>((byte*)this + 7680);
}
bool* ABP_NPC_Bandit_C::M_PtrGetStopSimulatingRagdoll() {
	return reinterpret_cast<bool*>((byte*)this + 7680);
}
...
struct FTimerHandle ABP_NPC_Bandit_C::M_GetRagdollTimer() const {
	return Read<struct FTimerHandle>((byte*)this + 7688);
}
struct FTimerHandle* ABP_NPC_Bandit_C::M_PtrGetRagdollTimer() {
	return reinterpret_cast<struct FTimerHandle*>((byte*)this + 7688);
}
...
bool ABP_NPC_Bandit_C::M_GetDamageTooSmall() const {
	return Read<bool>((byte*)this + 7696);
}
bool* ABP_NPC_Bandit_C::M_PtrGetDamageTooSmall() {
	return reinterpret_cast<bool*>((byte*)this + 7696);
}
...
TAssetPtr<class UParticleSystem> ABP_NPC_Bandit_C::M_GetDamageParticles() const {
	return Read<TAssetPtr<class UParticleSystem>>((byte*)this + 7704);
}
TAssetPtr<class UParticleSystem>* ABP_NPC_Bandit_C::M_PtrGetDamageParticles() {
	return reinterpret_cast<TAssetPtr<class UParticleSystem>*>((byte*)this + 7704);
}
...
/////////////////////////////////////////////
// Function BP_NPC_Bandit.BP_NPC_Bandit_C.Push Sounds
// Flags: Public, BlueprintCallable, BlueprintEvent
// Params:
/////////////////////////////////////////////
void ABP_NPC_Bandit_C::Push_Sounds() {
	static auto fn = UObject::FindObject<UFunction>("Function BP_NPC_Bandit.BP_NPC_Bandit_C.Push Sounds");

	struct ABP_NPC_Bandit_C_Push_Sounds_Params {
	};
	ABP_NPC_Bandit_C_Push_Sounds_Params params;
...
/////////////////////////////////////////////
// InheritableComponentHandler BP_NPC_Bandit.BP_NPC_Bandit_C.InheritableComponentHandler
// Flags: NetRequest, Native, MulticastDelegate, Public, Protected
// Params:
/////////////////////////////////////////////
void ABP_NPC_Bandit_C::InheritableComponentHandler() {
	static auto fn = UObject::FindObject<UFunction>("InheritableComponentHandler BP_NPC_Bandit.BP_NPC_Bandit_C.InheritableComponentHandler");

	struct ABP_NPC_Bandit_C_InheritableComponentHandler_Params {
	};
	ABP_NPC_Bandit_C_InheritableComponentHandler_Params params;
