...
#pragma region Members
	//struct FPointerToUberGraphFrame	UberGraphFrame;		//Offset: 7688	Size: 8	Flags: ZeroConstructor, Transient, DuplicateTransient
	...
	//class AActor*	DamageCauser;		//Offset: 7696	Size: 8	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	class AActor* M_GetDamageCauser() const;
	class AActor** M_PtrGetDamageCauser();
	void M_SetDamageCauser(const class AActor*& value);

	//struct FTimerHandle	HitTimer;		//Offset: 7704	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//struct FVector	HitLocation;		//Offset: 7712	Size: 12	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	struct FVector M_GetHitLocation() const;
	struct FVector* M_PtrGetHitLocation();
	void M_SetHitLocation(const struct FVector& value);

	//struct FName	HitBoneName;		//Offset: 7724	Size: 8	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	struct FName M_GetHitBoneName() const;
	struct FName* M_PtrGetHitBoneName();
	void M_SetHitBoneName(const struct FName& value);

	//struct FVector	ShotDirection;		//Offset: 7732	Size: 12	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//struct FTimerHandle	SplatTimer;		//Offset: 7744	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//struct FDateTime	Time;		//Offset: 7752	Size: 8	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	struct FDateTime M_GetTime() const;
	struct FDateTime* M_PtrGetTime();
	void M_SetTime(const struct FDateTime& value);

	//int32_t	SplatTime;		//Offset: 7760	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	int32_t M_GetSplatTime() const;
	int32_t* M_PtrGetSplatTime();
	void M_SetSplatTime(const int32_t& value);

	//TArray<struct FName>	HitBoneNames;		//Offset: 7768	Size: 16	Flags: Edit, BlueprintVisible, DisableEditOnInstance
	...
	//bool	CanHit;		//Offset: 7784	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetCanHit() const;
	bool* M_PtrGetCanHit();
	void M_SetCanHit(const bool& value);

	//bool	CanAvoid;		//Offset: 7785	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetCanAvoid() const;
	bool* M_PtrGetCanAvoid();
	void M_SetCanAvoid(const bool& value);

	//TEnumAsByte<E_AnimDirection>	AvoidDirection;		//Offset: 7786	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//TEnumAsByte<E_AnimMovement>	AvoidMovement;		//Offset: 7787	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	//float	TakeDamageMultiplier;		//Offset: 7788	Size: 4	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	float M_GetTakeDamageMultiplier() const;
	float* M_PtrGetTakeDamageMultiplier();
	void M_SetTakeDamageMultiplier(const float& value);

	//bool	StopSimulatingRagdoll;		//Offset: 7792	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetStopSimulatingRagdoll() const;
	bool* M_PtrGetStopSimulatingRagdoll();
	void M_SetStopSimulatingRagdoll(const bool& value);

	//struct FTimerHandle	RagdollTimer;		//Offset: 7800	Size: 8	Flags: Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash
	...
	//bool	DamageTooSmall;		//Offset: 7808	Size: 1	Flags: Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	bool M_GetDamageTooSmall() const;
	bool* M_PtrGetDamageTooSmall();
	void M_SetDamageTooSmall(const bool& value);

	//TAssetPtr<class UParticleSystem>	DamageParticles;		//Offset: 7816	Size: 40	Flags: Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash
