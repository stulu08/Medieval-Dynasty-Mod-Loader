...
public:
	...
	static inline void Trace_UML(const std::string& format, Args&& ...args) {
		s_umlLogger->Trace(format, std::forward<Args>(args)...);
	}
	template <typename ...Args>
	static inline void Info_UML(const std::string& format, Args&& ...args) {
		s_umlLogger->Info(format, std::forward<Args>(args)...);
	}
	template <typename ...Args>
	static inline void Warn_UML(const std::string& format, Args&& ...args) {
		s_umlLogger->Warn(format, std::forward<Args>(args)...);
	}
	template <typename ...Args>
	static inline void Error_UML(const std::string& format, Args&& ...args) {
		s_umlLogger->Error(format, std::forward<Args>(args)...);
	}
	template <typename ...Args>
	static inline void Critical_UML(const std::string& format, Args&& ...args) {
