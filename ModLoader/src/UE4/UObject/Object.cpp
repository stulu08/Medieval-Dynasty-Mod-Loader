...
namespace UE4 {
	...
	{
		auto Name = *reinterpret_cast<FName*>((byte*)this + MDML::SelectedGameProfile.defs.UObject.Name);
	...
	{
		return Read<int32_t>((byte*)this + MDML::SelectedGameProfile.defs.UObject.Index);
	};

	UClass* UObject::GetClass() const
	{
		return Read<class UClass*>((byte*)this + MDML::SelectedGameProfile.defs.UObject.Class);
	};

	UObject* UObject::GetOuter() const
	{
		return Read<UObject*>((byte*)this + MDML::SelectedGameProfile.defs.UObject.Outer);
	};
	...
	void UObject::ProcessEvent(class UFunction* function, void* parms) {
		if (function)
			return reinterpret_cast<void(*)(UObject*, class UFunction*, void*)>(MDML::SelectedGameProfile.ProcessEvent)(this, function, parms);
	}
	...
	{
		return reinterpret_cast<UObject * (__fastcall*)(class UClass*, UObject*, const wchar_t*, const wchar_t*, uint32_t, void*, bool, const void*)>(MDML::SelectedGameProfile.StaticLoadObject)(uclass, InOuter, InName, Filename, (uint32_t)LoadFlags, Sandbox, bAllowObjectReconciliation, InstancingContext);
	}

	UObject* UObject::StaticFindObject(UClass* uclass, UObject* InOuter, const wchar_t* Name, bool ExactClass)
	{
		return reinterpret_cast<UObject * (__fastcall*)(class UClass*, UObject*, const wchar_t*, bool)>(MDML::SelectedGameProfile.StaticFindObject)(uclass, InOuter, Name, ExactClass);
	}
	...
	{
		if (MDML::SelectedGameProfile.StaticConstructObject_Internal)
		{
			if (MDML::SelectedGameProfile.IsUsingUpdatedStaticConstruct)
			{
				...
				return reinterpret_cast<UObject * (__fastcall*)(const FStaticConstructObjectParameters*)>(MDML::SelectedGameProfile.StaticConstructObject_Internal)(&StaticConstructObjectParameters);
			}
			else
			{
				return reinterpret_cast<UObject * (__fastcall*)(UClass*, UObject*, FName, unsigned int, unsigned int, UObject*, bool, void*, bool)>(MDML::SelectedGameProfile.StaticConstructObject_Internal)(Class, InOuter, Name, SetFlags, (unsigned int)InternalSetFlags, Template, bCopyTransientsFromClassDefaults, InstanceGraph, bAssumeTemplateIsArchetype);
			}
		}
		else
		{
			Log::Error_UML("StaticConstructObject_Internal Called But Not Found!");
		}
		return nullptr;
	}
	...
	{
		return reinterpret_cast<bool (*)(UE4::UObject*, const wchar_t*, void*, UE4::UObject*, bool)>(MDML::SelectedGameProfile.CallFunctionByNameWithArguments)(this, Str, Ar, Executor, bForceCallWithNonExec);
	}
}