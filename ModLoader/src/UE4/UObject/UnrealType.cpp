...
namespace UE4 {
	int32_t FProperty::GetArrayDim() const {
		return Read<int32_t>((byte*)this + MDML::SelectedGameProfile.defs.Property.ArrayDim);
	};

	int32_t FProperty::GetElementSize() const {
		return Read<int32_t>((byte*)this + MDML::SelectedGameProfile.defs.Property.ElementSize);
	}

	EPropertyFlags FProperty::GetPropertyFlags() const {
		return (EPropertyFlags)Read<uint64_t>((byte*)this + MDML::SelectedGameProfile.defs.Property.Flags);
	}

	int32_t FProperty::GetOffset() const {
		return Read<int32_t>((byte*)this + MDML::SelectedGameProfile.defs.Property.Offset);
	}
	...
	{
		auto Name = *reinterpret_cast<FName*>((byte*)this + MDML::SelectedGameProfile.defs.FFieldClass.Name);
	...
	{
		return Read<uint64_t>((byte*)this + MDML::SelectedGameProfile.defs.FFieldClass.ID);
	}

	uint64_t FFieldClass::GetCastFlags() const
	{
		return Read<uint64_t>((byte*)this + MDML::SelectedGameProfile.defs.FFieldClass.CastFlags);
	}

	FFieldClass* FFieldClass::SuperClass() const
	{
		return Read<class FFieldClass*>((byte*)this + MDML::SelectedGameProfile.defs.FFieldClass.SuperClass);
	}
...
#define AS_UClASS_CHECK(X) \
	...
	{
		return Read<class FFieldClass*>((byte*)this + MDML::SelectedGameProfile.defs.FField.ClassPrivate);
	}

	FField* FField::GetNext() const
	{
		return Read<class FField*>((byte*)this + MDML::SelectedGameProfile.defs.FField.Next);
	};

	std::string FField::GetName() const
	{
		auto Name = *reinterpret_cast<FName*>((byte*)this + MDML::SelectedGameProfile.defs.FField.Name);
		if (UE4::FName::GetFNamePool().IsValidIndex(Name.ComparisonIndex))
		{
			return Name.GetName();
		}
	...
	UEnum* FByteProperty::GetEnum() const {
		return Read<class UEnum*>((byte*)this + MDML::SelectedGameProfile.defs.ByteProperty.Enum);
	}
	uint8_t FBoolProperty::GetFieldSize() const {
		return Read<uint8_t>((byte*)this + MDML::SelectedGameProfile.defs.BoolProperty.FieldSize);
	}
	uint8_t FBoolProperty::ByteOffset() const {
		return Read<uint8_t>((byte*)this + MDML::SelectedGameProfile.defs.BoolProperty.ByteOffset);
	}
	uint8_t FBoolProperty::ByteMask() const {
		return Read<uint8_t>((byte*)this + MDML::SelectedGameProfile.defs.BoolProperty.ByteMask);
	}
	uint8_t FBoolProperty::FieldMask() const {
		return Read<uint8_t>((byte*)this + MDML::SelectedGameProfile.defs.BoolProperty.FieldMask);
	}
	UClass* FObjectPropertyBase::GetPropertyClass() const {
		return Read<class UClass*>((byte*)this + MDML::SelectedGameProfile.defs.ObjectPropertyBase.PropertyClass);
	}
	UClass* FClassProperty::GetMetaClass() const {
		return Read<class UClass*>((byte*)this + MDML::SelectedGameProfile.defs.ClassProperty.MetaClass);
	}
	UClass* FInterfaceProperty::GetInterfaceClass() const {
		return Read<class UClass*>((byte*)this + MDML::SelectedGameProfile.defs.InterfaceProperty.InterfaceClass);
	}
	UClass* FAssetClassProperty::GetMetaClass() const {
		return Read<class UClass*>((byte*)this + MDML::SelectedGameProfile.defs.AssetClassProperty.MetaClass);
	}
	UScriptStruct* FStructProperty::GetStruct() const {
		return Read<class UScriptStruct*>((byte*)this + MDML::SelectedGameProfile.defs.StructProperty.Struct);
	}
	FProperty* FArrayProperty::GetInner() const {
		return Read<class FProperty*>((byte*)this + MDML::SelectedGameProfile.defs.ArrayProperty.Inner);
	}
	FProperty* FMapProperty::GetKeyProp() const {
		return Read<class FProperty*>((byte*)this + MDML::SelectedGameProfile.defs.MapProperty.Key);
	}
	FProperty* FMapProperty::GetValueProp() const {
		return Read<class FProperty*>((byte*)this + MDML::SelectedGameProfile.defs.MapProperty.Value);
	}
	UFunction* FDelegateProperty::GetSignatureFunction() const {
		return Read<class UFunction*>((byte*)this + MDML::SelectedGameProfile.defs.DelegateProperty.SignatureFunction);
	}
	UFunction* FMulticastDelegateProperty::GetSignatureFunction() const {
		return Read<class UFunction*>((byte*)this + MDML::SelectedGameProfile.defs.MulticastDelegateProperty.SignatureFunction);
	}
	FNumericProperty* FEnumProperty::GetUnderlyingProp() const {
		return Read<class FNumericProperty*>((byte*)this + MDML::SelectedGameProfile.defs.EnumProperty.UnderlyingProp);
	}
	UEnum* FEnumProperty::GetEnum() const {
		return Read<class UEnum*>((byte*)this + MDML::SelectedGameProfile.defs.EnumProperty.Enum);
	}
}